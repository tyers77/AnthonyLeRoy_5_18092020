...
let idProduct = param.get("id");/*repère dans l API on veut ID*/
...
addPanier = () => {
    ...
    inputBuy.addEventListener("click", function () {  /*évènement: Au clic de l'utilisateur pour mettre le produit dans le panier*/
        ...
        if (Array.isArray(userPanier)) {
            ...
            console.log("le panier n'existe pas, il va être créer et l'envoyer dans le localStorage");
